                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('auth.save') }}">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Complete Address') }}</label>

                                <div class="col-md-6">
                                    <input id="complete_address" type="text" class="form-control" name="complete_address" value="{{ old('complete_address') }}">
                                    <span class="alert-danger" role="alert">
                                        @error('complete_address'){{ $message }} @enderror
                                    </span>
                            ...
                            <div class="form-group row mb-2">
                                <div class="col-md-8 offset-md-4">
                                    I don't have an account&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ route('auth.login') }}"><button type="button" class="btn btn-info btn-sm">Sign In</button></a>
                                </div>
                            </div>
                        </form>
                    </div>
